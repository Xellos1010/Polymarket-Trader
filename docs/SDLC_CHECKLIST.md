...
- [x] License set to MIT in `Cargo.toml` and **root `LICENSE` file** for OSS clarity
- [x] Documentation portal + runbooks (`docs/README.md`, `docs/runbooks/`)
...
- [x] `SECURITY.md` and `CODE_OF_CONDUCT.md` at repo root; `ROADMAP.md` for public orientation
- [x] Historical program notes archived under `docs/archive/program-history-2026/`
...
- [x] Root `ROADMAP.md` + doc portal (`docs/README.md`) link security, conduct, and roadmap
