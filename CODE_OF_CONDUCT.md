...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at the **same private channel used for [SECURITY.md](SECURITY.md) reports** (GitHub Security Advisories or maintainer-agreed contact). All complaints will be reviewed and investigated promptly and fairly.
...
1. **Correction** — A private, written warning with clarity around the violation and an explanation of why the behavior was inappropriate.  
