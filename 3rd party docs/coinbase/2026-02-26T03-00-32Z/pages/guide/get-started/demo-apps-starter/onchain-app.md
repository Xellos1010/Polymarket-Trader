...
An Onchain App Template built with [OnchainKit](https://onchainkit.xyz/), and ready to be deployed to Vercel. Play with it live on [https://onchain-app-template.vercel.app](https://onchain-app-template.vercel.app/) Have fun! ⛵️
