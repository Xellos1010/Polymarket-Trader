...
-   [Coinbase Developer Platform Postman Environment](https://developer.chrome.com/get-started/downloads/coinbase_developer_platform.postman_environment.json) (Required for all Collections)
-   [Coinbase Advanced Trade Postman Collection](https://developer.chrome.com/get-started/downloads/coinbase_advanced_trading.postman_collection.json)
-   [Coinbase App Postman Collection](https://developer.chrome.com/get-started/downloads/coinbase_app.postman_collection.json)
-   [CDP SDK Collection](https://developer.chrome.com/get-started/downloads/cdp_sdk_collection.postman_collection.json)
...
1.  **Download Postman Environment:**
    -   [Coinbase Developer Platform Postman Environment](https://developer.chrome.com/get-started/downloads/coinbase_developer_platform.postman_environment.json)
...
3.  **Select the Environment:**
    ...
    -   Or by using the **Environments** tab on the left bar - Make sure the correct environment is selected by checking the check mark to the right of the environment name in Postman.
4.  **Set Up Variables:**
