...
**Optional** An unguessable random string to protect against cross-site request forgery attacks. Must be at least 8 characters long. [Read more](https://developer.chrome.com/coinbase-app/authentication-authorization/oauth2/security-best-practices)
...
You can further customize the authorization page and permissions. Read more at [OAuth2 reference](https://developer.chrome.com/coinbase-app/authentication-authorization/oauth2/reference).
