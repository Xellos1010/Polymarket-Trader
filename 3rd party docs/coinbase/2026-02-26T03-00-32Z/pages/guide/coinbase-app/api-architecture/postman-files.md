...
-   [Coinbase Developer Platform Coinbase App Postman Collection](https://developer.chrome.com/coinbase-app/api-architecture/files/coinbase_app.postman_collection.json)
-   [Coinbase Developer Platform Postman Environment](https://developer.chrome.com/coinbase-app/api-architecture/files/coinbase_developer_platform.postman_environment.json)
...
> **Info** Coinbase Cloud is in the process of being rebranded as Coinbase Developer Platform (CDP). Some documentation and naming conventions may still reflect the old branding.
...
1.  **Download Collection:**
    -   Download the [Coinbase Developer Platform Coinbase App Postman Collection](https://developer.chrome.com/coinbase-app/api-architecture/files/coinbase_app.postman_collection.json)
