...
The client is the entity that initiates a request to access a paid resource. Clients can include:
...
The server is the resource provider enforcing payment for access to its services. Servers can include:
...
For a detailed explanation of the complete payment flow between clients and servers, see [How x402 Works](https://developer.chrome.com/x402/core-concepts/how-it-works).
...
This interaction is stateless, HTTP-native, and compatible with both human applications and automated agents. Next, explore:

-   [How x402 Works](https://developer.chrome.com/x402/core-concepts/how-it-works): See the complete payment flow
-   [Facilitator](https://developer.chrome.com/x402/core-concepts/facilitator): How servers verify and settle payments
-   [HTTP 402](https://developer.chrome.com/x402/core-concepts/http-402): How servers communicate payment requirements to clients