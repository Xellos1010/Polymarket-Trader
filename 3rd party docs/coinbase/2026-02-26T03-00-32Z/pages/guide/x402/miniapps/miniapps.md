...
2.  **FACILITATOR\_URL**: Use `https://www.x402.org/facilitator` for testnet, or the CDP facilitator for mainnet
...
-   [x402 Protocol Documentation](https://developer.chrome.com/x402/welcome)
