...
The v2 Server Wallet allows you to create [accounts](https://developer.chrome.com/server-wallets/v2/introduction/accounts) on EVM compatible networks and the Solana network. In this quickstart, you will learn how to:
...
Setup all dependencies, export your keys to environment variables, and initialize a new project before you begin. It is assumed you have:
...
Sign in to the [CDP Portal](https://portal.cdp.coinbase.com/), [create a CDP API key](https://portal.cdp.coinbase.com/projects/api-keys) and [generate a Wallet Secret](https://portal.cdp.coinbase.com/products/server-wallet/accounts). Keep these values handy as you will need them in the following steps. For more information, see the [CDP API Keys](https://developer.chrome.com/get-started/authentication/cdp-api-keys#secret-api-keys) and [Wallet Secret](https://developer.chrome.com/server-wallets/v2/introduction/security#wallet-secret) documentation.
...
The v2 Server Wallet offers support for both [EVM compatible accounts and Solana accounts](https://developer.chrome.com/server-wallets/v2/introduction/accounts).
...
Accounts do not have funds on creation. We provide a [Faucet API](https://developer.chrome.com/faucets/introduction/welcome) to easily fund your EVM account with testnet tokens and Solana account with devnet tokens.
...
You can send transactions using the v2 Server Wallet.Note that in order to wait for transaction confirmation, you will need to have `viem` installed:
...
You can send transactions using the v2 Server Wallet.Note that in order to wait for transaction confirmation, you will need to have `web3` installed:
...
-   [v2 Wallet Accounts](https://developer.chrome.com/server-wallets/v2/introduction/accounts): An overview of the types of accounts supported by the v2 Server Wallet.
-   [Using Smart Accounts](https://developer.chrome.com/server-wallets/v2/evm-features/smart-accounts): A step-by-step guide on how to create and use smart accounts.
-   [v2 Wallet Security](https://developer.chrome.com/server-wallets/v2/introduction/security): Learn about the security features of the v2 Server Wallet.
-   [Faucets](https://developer.chrome.com/faucets/introduction/welcome): Learn more on supported testnet assets and their associated rate limits.