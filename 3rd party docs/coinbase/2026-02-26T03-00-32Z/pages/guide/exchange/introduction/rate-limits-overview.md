...
### [REST API Rate Limits](https://developer.chrome.com/exchange/rest-api/rate-limits)
...
### [FIX API Rate Limits](https://developer.chrome.com/exchange/fix-api/rate-limits)
...
-   Maximum connections per profile: 75. See [FIX Best Practices](https://developer.chrome.com/exchange/fix-api/best-practices).
...
### [Websocket Rate Limits](https://developer.chrome.com/exchange/websocket-feed/rate-limits)
