...
For more information, see [CDP API Keys](https://developer.chrome.com/get-started/authentication/cdp-api-keys).
...
To create a Secret API key (for server-to-server communication), ensure the **Secret API Keys** tab is selected as shown in the previous step. Click the **Create API key** button and give your key a name. You also have the option to:

-   Set an IP allowlist for the key
-   Restrict granular permissions such as the ability to trade or transfer funds
-   Select between Ed25519 (Recommended) or ECDSA [signature algorithms](https://developer.chrome.com/get-started/authentication/cdp-api-keys#ed25519-signature-algorithm)
...
A JWT is a compact, self-contained, stateless token format used to securely transmit API keys as a JSON object for authentication with the CDP API.Read more in our [JWT documentation](https://developer.chrome.com/get-started/authentication/cdp-api-keys#learn-more-about-jwts).
...
You can create a new project directory, but we will handle the bulk of Go in the [Export](https://developer.chrome.com/api-reference/authentication#export) section below.
...
As an example, [Get Asset by ID](https://developer.chrome.com/api-reference/rest-api/assets/get-assets-by-id) could be requested like so:
...
As an example, you can request the [List Historical Balances](https://developer.chrome.com/api-reference/json-rpc-api/address-history#cdp-listbalancehistories) JSON-RPC endpoint like so:
...
-   **[Security Best Practices](https://developer.chrome.com/get-started/authentication/security-best-practices)**: Learn how to secure your API keys and other sensitive information.
-   **[CDP API Keys](https://developer.chrome.com/get-started/authentication/cdp-api-keys)**: Learn how to create and manage your API keys.
-   **[JWT Authentication](https://developer.chrome.com/get-started/authentication/jwt-authentication)**: More information on JWT authentication.
-   **[CDP cURL](https://developer.chrome.com/get-started/authentication/cdp-curl)**: Learn how to use our CLI tool to interact with the CDP API.
-   **[Postman Files](https://developer.chrome.com/get-started/authentication/postman-files)**: Download our Postman collection and environment files to get started.