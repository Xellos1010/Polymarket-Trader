...
Source account ID is malformed

`"source is invalid."`

Target account ID is malformed
...
Asset not supported at source

`"source is not supported."`

Asset not supported at target

`"target is not supported."`

Target email address is malformed

`"target has an invalid email format."`

Target onchain address is invalid for network

`"The recipient address is invalid for the selected network."`

Asset not supported for this transfer route

`"Transfer asset pair is not supported."`

Insufficient balance

`"Insufficient funds to complete this transfer."`

Asset mismatch between request fields

`"Currency mismatch in request."`

Metadata has too many keys

`"Metadata has too many keys. Up to 50 key/value pairs are permitted."`

Metadata key exceeds length limit

`"Metadata key is too long. Each key must be less than or equal to 40 characters."`

Metadata value exceeds length limit

`"Metadata value is too long. Each value must be less than or equal to 500 characters."`

Travel rule fields missing

`"Travel rule information is incomplete. Missing fields: ..."`

Recipient address not in account allowlist

`"Your coinbase account allowlist does not include this address. Please update your allowlist at https://www.coinbase.com/settings/allowlist"`
...
{
  "errorType": "invalid_request",
  "errorMessage": "Your coinbase account allowlist does not include this address. Please update your allowlist at https://www.coinbase.com/settings/allowlist",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "source is not supported.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "target is not supported.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "target has an invalid email format.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Transfer asset pair is not supported.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Insufficient funds to complete this transfer.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
1.  Reduce the number of metadata entries (maximum 50 allowed)
...
{
  "errorType": "invalid_request",
  "errorMessage": "Metadata has too many keys. Up to 50 key/value pairs are permitted.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Metadata key is too long. Each key must be less than or equal to 40 characters.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Metadata value is too long. Each value must be less than or equal to 500 characters.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Travel rule information is incomplete. Missing fields: originator.name.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
{
  "errorType": "invalid_request",
  "errorMessage": "Currency mismatch in request.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
...
```
{
  ...
  "errorMessage": "Transfer blocked due to travel rule compliance.",
  "correlationId": "41deb8d59a9dc9a7-IAD",
