...
-   `jwt` can be generated by running one of the code snippets provided in the [WebSocket Authentication page](https://developer.chrome.com/coinbase-app/advanced-trade-apis/websocket/websocket-authentication). Remember that you must generate a different JWT for each websocket message sent, since the JWTs will expire after 2 minutes.
...
-   [WebSocket Rate Limits](https://developer.chrome.com/coinbase-app/advanced-trade-apis/websocket/websocket-rate-limits)